...
import (
	...
	gtfsrealtime "proto/gtfsrealtime"
	reflect "reflect"
	sync "sync"
	unsafe "unsafe"
)
...
type TripReplacementPeriod struct {
	...
	ReplacementPeriod *gtfsrealtime.TimeRange `protobuf:"bytes,2,opt,name=replacement_period,json=replacementPeriod" json:"replacement_period,omitempty"`
...
func (x *TripReplacementPeriod) GetReplacementPeriod() *gtfsrealtime.TimeRange {
	if x != nil {
...
var file_gtfs_realtime_NYCT_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*gtfsrealtime.FeedHeader)(nil),
	...
	{
		ExtendedType:  (*gtfsrealtime.TripDescriptor)(nil),
	...
	{
		ExtendedType:  (*gtfsrealtime.TripUpdate_StopTimeUpdate)(nil),
...
// Extension fields to gtfsrealtime.TripUpdate_StopTimeUpdate.
var (
...
const file_gtfs_realtime_NYCT_proto_rawDesc = "" +
	"\n" +
	"\x18gtfs-realtime-NYCT.proto\x12\x10transit_realtime\x1a/com/google/transit/realtime/gtfs-realtime.proto\"~\n" +
	...
	"\x1bcom.google.transit.realtimeZ\x0eproto/gtfsnyct"
...
var file_gtfs_realtime_NYCT_proto_goTypes = []any{
	...
	(*gtfsrealtime.TimeRange)(nil),                 // 5: transit_realtime.TimeRange
	(*gtfsrealtime.FeedHeader)(nil),                // 6: transit_realtime.FeedHeader
	(*gtfsrealtime.TripDescriptor)(nil),            // 7: transit_realtime.TripDescriptor
	(*gtfsrealtime.TripUpdate_StopTimeUpdate)(nil), // 8: transit_realtime.TripUpdate.StopTimeUpdate
}
